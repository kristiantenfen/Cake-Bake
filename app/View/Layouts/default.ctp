...
//                echo $this->Html->css('admin/stylesheet');
                ...
                echo $this->Html->script('admin/actions');
                echo $this->Html->script('admin/cookies');
...
<!--       <div class="breadLine">            
        ...
        <ul class="navigation">            
            <li class="active">
                <a href="<?php echo $this->Html->url('/compras', true)?>">
                    <span class="isw-grid"></span><span class="text">Compras</span>
                </a>
            </li>
          <!--  <li class="openable">
                <a href="#">
